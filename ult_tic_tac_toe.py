LOC = {"corner": [(0, 0), (0, 2), (2, 0), (2, 2)],
       "other": [(0, 1), (1, 0), (1, 2), (2, 1)]}
CENTER = (1, 1)
...
class Board():
    ...
    def check_diagonals(self, row, col):
        if self.board[0][0] == self.board[1][1] and self.board[1][1] == self.board[2][2] and self.board[0][0] == self.board[row][col]:
            return True
        if self.board[0][2] == self.board[1][1] and self.board[1][1] == self.board[2][0] and self.board[0][2] == self.board[row][col]:
            return True
        return False
...
class Ultimate_board():
    ...
    def check_diagonals(self, row, col):
        if self.board[0][0].winner == self.board[1][1].winner and self.board[1][1].winner == self.board[2][2].winner and self.board[0][2].winner == self.board[row][col].winner:
            return True
        if self.board[0][2].winner == self.board[1][1].winner and self.board[1][1].winner == self.board[2][0].winner and self.board[0][2].winner == self.board[row][col].winner:
            return True
        return False
